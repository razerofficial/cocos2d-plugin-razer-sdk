...
public class CallbacksInitPlugin {

	private final String TAG  = CallbacksInitPlugin.class.getSimpleName();

	private static final boolean sEnableLogging = false;

	public native void CallbacksInitPluginOnSuccess();
	public native void CallbacksInitPluginOnFailure(int errorCode, String errorMessage);

	public void onSuccess() {
		if (sEnableLogging) {
			Log.d(TAG, "onSuccess");
		}
		CallbacksInitPluginOnSuccess();
	}
