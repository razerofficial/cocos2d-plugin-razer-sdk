...
void CallbacksContentSearchInstalled::OnError(int code, const std::string& reason)
{
}

void CallbacksContentSearchInstalled::OnResults(const std::vector<GameMod> gameMods, int count)
{
}
